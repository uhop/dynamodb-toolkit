 ...
 * @returns A fresh random string of exactly `length` characters, drawn uniformly
 *   from `[a-z0-9]`. Not cryptographically strong for secrets — it's a unique-enough tag.
 */
